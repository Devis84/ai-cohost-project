...
function createDraftFromTask(task: CleaningTask): TaskDraft {
  return {
    ...
    hourly_rate:
      task.hourly_rate === undefined || task.hourly_rate === null
        ? ""
    ...
    <div className="min-h-screen bg-[#f5f5f5] p-5 md:p-6">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white/10 border border-white/10 rounded-3xl p-5">
                <div className="text-white/50 text-sm mb-2">Open</div>
                <div className="text-3xl font-bold">{openTasks}</div>
              </div>

              <div className="bg-white/10 border border-white/10 rounded-3xl p-5">
                <div className="text-white/50 text-sm mb-2">Hours</div>
              ...
              <div className="bg-green-500/15 border border-green-400/20 rounded-3xl p-5">
                <div className="text-green-100 text-sm mb-2">Payable</div>
              ...
              <div className="bg-red-500/15 border border-red-400/20 rounded-3xl p-5">
                <div className="text-red-100 text-sm mb-2">Missing Data</div>
            ...
            <div className="space-y-4">
              {cleanerSummary.map((item) => (
                ...
                >
                  ...
                  {(item.missingTime > 0 || item.missingRate > 0) && (
                  ...
                  <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, item.hours * 10)}%`,
                      }}
                    />
                  </div>
                </div>
        ...
        <div className="grid lg:grid-cols-5 gap-4">
          ...
          <div className="bg-white rounded-3xl p-5 shadow border border-black/5">
            <div className="text-gray-500 text-sm mb-2">Accepted</div>
          ...
          <div className="bg-red-50 rounded-3xl p-5 shadow border border-red-100">
            <div className="text-red-500 text-sm mb-2">Urgent</div>
                          ...
                          <div className="flex-1 space-y-5">
                            ...
                            <div className="grid md:grid-cols-4 gap-3">
                              ...
                              <div className="bg-gray-50 rounded-2xl p-4">
                                ...
                                <div className="font-semibold">
                                  {formatMoney(draftAmount, currency)}
                                </div>
