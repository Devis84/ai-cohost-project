  ...
  return (
    <>
      <section className="bg-white rounded-[32px] p-7 shadow-xl border border-black/5">
        ...
        {isLimitedAccess && (
          <div className="mb-5 rounded-3xl border border-amber-100 bg-amber-50 p-5">
            <div className="mb-2 text-sm font-bold uppercase tracking-[0.2em] text-amber-800">
              Limited Partner Access
            </div>

            <p className="text-sm leading-relaxed text-amber-950/75">
              This account can only view and edit the properties assigned by
              the admin. Creating new properties and deleting properties are
              disabled for this test access.
            </p>
          </div>
        )}
        ...
        <div className="grid md:grid-cols-[1fr_auto] gap-4 mb-4">
          ...
          {canDeleteProperty ? (
            ...
            <div className="bg-gray-100 text-gray-500 px-6 py-4 rounded-2xl text-sm font-semibold text-center">
              Delete disabled
            </div>
          )}
        </div>
        ...
        {canCreateProperty ? (
          ...
          <div className="mb-4 rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600">
            New property creation is disabled for this account. The admin
            pre-creates the test properties, and this account can complete and
            edit the assigned property content.
          </div>
        )}
